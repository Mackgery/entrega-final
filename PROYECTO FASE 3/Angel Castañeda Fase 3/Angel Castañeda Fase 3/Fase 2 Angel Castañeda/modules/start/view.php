      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Bienvenido <strong><?php echo $_SESSION['name_user']; ?></strong> a la aplicación de inventario de materiales.
          </p>        
        </div>
      </div>  
    </div>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          ...
          if ($_SESSION['permisos_acceso']!='gerente') { ?>
            <a h    ref="?module=form_medicines&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          <div class="inner">
            ...
            ?>
            <h3><?php echo $data['numero']; ?></h3>
            <p>Datos de entrada de Materiales</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            ?>
            <h3><?php echo $data['numero']; ?></h3>
            <p>MODULO DE CUENTAS POR PAGAR</p>
          </div>
          <div class="icon">
            <i class="fa fa-folder"></i>
          </div>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            ?>
            <h3><?php echo $data['numero']; ?></h3>
            <p>MODULO DE CUENTAS POR COBRAR</p>
          </div>
          <div class="icon">
            <i class="fa fa-folder"></i>
          </div>
