  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo.png" alt="Logo" height="50"> <b>SISTEMA ERP DESARROLLO WEB</b>
      </div><!-- /.login-logo -->
      <?php  
