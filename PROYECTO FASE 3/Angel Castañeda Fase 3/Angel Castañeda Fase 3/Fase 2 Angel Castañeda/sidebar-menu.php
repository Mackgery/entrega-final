...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="medicines" || $_GET["module"]=="form_medicines") { ?>
    <li class="active">
      <a href="?module=medicines"><i class="fa fa-folder"></i> Datos de Materiales </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="medicines_transaction" || $_GET["module"]=="form_medicines_transaction") { ?>
    <li class="active">
      <a href="?module=medicines_transaction"><i class="fa fa-clone"></i> Registro de Materiales </a>
      </li>
  <?php
  }
  ...
  <?php
	...
	if ($_GET["module"]=="stock_inventory") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro de Materiales</a></li>
      		</ul>
    	</li>
    <?php
	}
	...
	elseif ($_GET["module"]=="stock_report") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=stock_inventory"><i class="fa fa-circle-o"></i> Stock de Materiales </a></li>
        		<li class="active"><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro de Materiales </a></li>
      		</ul>
    	</li>
    <?php
	}
...
elseif ($_SESSION['permisos_acceso']=='Gerente') { ?>
  ...
  if ($_GET["module"]=="stock_inventory") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="?module=stock_inventory"><i class="fa fa-circle-o"></i> Stock de Materiales</a></li>
            <li><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Registro de Materiales </a></li>
          </ul>
      </li>
    <?php
