...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Inventario de Producto sistema ERP</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Inventario de Materiales">
    <meta name="author" content="Inventario de  Materiales - Sistemas Web Angel Castañeda" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:20px">SISTEMA ERP</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://obedalvarado.pw/" target="_blank">Sistemas Web ERP DESARROLLO WEB</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
